...
class FormsAlias
{
    ...
    const ZYGARGE_TENTH = Mods::FORM2;
    ...
    const MORPEKO_BELLY = Mods::FORM1;
    const MORPEKO_HANGRY = Mods::FORM2;
    const ZACIAN_HERO = Mods::FORM1;
    const ZACIAN_CROWNED = Mods::FORM2;
